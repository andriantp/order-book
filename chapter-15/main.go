...
func main() {
	...
	detector.Register("Engine-0")
	detector.Register("Engine-1")
	detector.Register("Engine-2")
	...
	// Simulate a primary engine failure.
	fmt.Println("=== Simulating Engine Failure ===")
	detector.Fail("Engine-0")
	fmt.Println("Engine-0 is unavailable")
	fmt.Println()
...
func newEngine(name string) *engine.Engine {
	...
	return &engine.Engine{
		...
		ReadModel:  marketdata.NewReadModel(),
	}
}
